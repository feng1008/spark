...
LOG_PATH=s3://datamining.ym/user_profile/last5/${THIS_DAY}/
PRO_PATH=s3://datamining.ym/lsjp/province/${DATE}
TIME_PATH=s3://datamining.ym/lsjp/time/${DATE}
PAIRS_PATH=s3://datamining.ym/lsjp/pairs/${DATE}

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=GetLast5Package,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"get pro_tm_pairs $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,20,/home/hadoop/letv_pro_tm_pairs.py,$AOS_PATH,$IOS_PATH,$LOG_PATH,$PRO_PATH,$TIME_PATH,$PAIRS_PATH]`
