...
CLUSTER_NAME="awscn-up-emr-letv_pro_tm_pairs"
...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/letv_pro_tm_pairs.py --dest /home/hadoop/letv_pro_tm_pairs.py
...
AOS_PATH=s3://datamining.ym/user_profile/dict/letv_aos
IOS_PATH=s3://datamining.ym/user_profile/dict/letv_ios
LOG_PATH=s3://logarchive.ym/hive/gztables/default_log/dt=${THIS_DAY}/sv=3/ac=304/
PRO_PATH=s3://datamining.ym/lsjp/province/${THIS_DAY}
TIME_PATH=s3://datamining.ym/lsjp/time/${THIS_DAY}
PAIRS_PATH=s3://datamining.ym/lsjp/pairs/${THIS_DAY}

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=GetLast5Package,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"get letv_pro_tm_pairs $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,10,/home/hadoop/letv_pro_tm_pairs.py,$AOS_PATH,$IOS_PATH,$LOG_PATH,$PRO_PATH,$TIME_PATH,$PAIRS_PATH]`
