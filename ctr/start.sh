...
CLUSTER_NAME="awscn-up-emr-mllib_gbdt"
...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/ctr_mllib_gbdt.py --dest /home/hadoop/ctr_mllib_gbdt.py
...
FEATURE_FILE=s3://datamining.ym/mllib_ctr/data/test_file
MODEL_PATH=s3://datamining.ym/mllib_ctr/model/mllib_gbdt

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=interest,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"Count interest $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--driver-memory,3G,--total-executor-cores,10,/home/hadoop/ctr_mllib_gbdt.py,$FEATURE_FILE,$MODEL_PATH]`
