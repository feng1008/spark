...
CLUSTER_NAME="awscn-up-emr-install"
...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/ctr_imei_install1013.py --dest /home/hadoop/ctr_imei_install1013.py
...
IMEI_PATH=s3://logarchive.ym/rtb/feed/sv=1/dt=2015-10-1*/ac=0/
INSTALL_PATH=s3://logarchive.ym/user_packages/1509/aos/
OUTPUT_PATH=s3://datamining.ym/user_profile/commerce/ctr/inst_pred/${DATE}
TEMP_PATH=s3://datamining.ym/user_profile/commerce/temp/${DATA}

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=interest,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"Count interest $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,20,/home/hadoop/ctr_imei_install1013.py,$IMEI_PATH,$INSTALL_PATH,$OUTPUT_PATH,$TEMP_PATH]`
