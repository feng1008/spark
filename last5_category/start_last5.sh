...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/getdict.py --dest /home/hadoop/getdict.py
...
INPUT_PATH=s3://datamining.ym/user_profile/last5/2015-09*/
IMEI_PATH=s3://datamining.ym/user_profile/commerce/last5_dict/aos/${DATE}
IDFA_PATH=s3://datamining.ym/user_profile/commerce/last5_dict/ios/${DATE}

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=GetLast5Package,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"get last5 dict $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,20,/home/hadoop/getdict.py,$INPUT_PATH,$IMEI_PATH,$IDFA_PATH]`
