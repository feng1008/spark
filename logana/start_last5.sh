...
CLUSTER_NAME="awscn-up-emr-last5"
...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/letv_last5.py --dest /home/hadoop/letv_last5.py
...
OUT_PATH=s3://datamining.ym/lsjp/last5/${DATE}

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=GetLast5Package,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"get last5 dict $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,10,/home/hadoop/letv_last5.py,$AOS_PATH,$IOS_PATH,$LAST5_PATH,$OUT_PATH]`
