...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/log_analysis_1120.py --dest /home/hadoop/log_analysis_1120.py
...
CID_PATH=s3://logarchive.ym/cid_property/1510/
...
PROVINCE_PATH=s3://datamining.ym/log_analysis/province/${THIS_DAY}
TIME_PATH=s3://datamining.ym/log_analysis/time/${THIS_DAY}
DEVICE_PATH=s3://datamining.ym/log_analysis/device/${THIS_DAY}
HEI_WID_PATH=s3://datamining.ym/log_analysis/hei_wid/${THIS_DAY}
APP_PATH=s3://datamining.ym/log_analysis/app/${THIS_DAY}

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=GetLast5Package,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"get log_analysis $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--driver-memory,3G,--total-executor-cores,40,/home/hadoop/log_analysis_1120.py,$CID_PATH,$LOG_PATH,$PROVINCE_PATH,$TIME_PATH,$DEVICE_PATH,$HEI_WID_PATH,$APP_PATH]`
