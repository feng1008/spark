...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/lr_spark.py --dest /home/hadoop/lr_spark.py
...
APP_SET_PATH=s3://datamining.ym/user_profile/commerce/lrdata/app_set
POSITIVE_INPUT=s3://datamining.ym/user_profile/commerce/lrdata/positive_sample
NEGATIVE_INPUT=s3://datamining.ym/user_profile/commerce/lrdata/negative_sample
POSITIVE_OUTPUT=s3://datamining.ym/user_profile/commerce/lrdata/positive_train
NEGATIVE_OUTPUT=s3://datamining.ym/user_profile/commerce/lrdata/negative_train

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=interest,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"Count interest $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,10,/home/hadoop/lr_spark.py,$APP_SET_PATH,$POSITIVE_INPUT,$NEGATIVE_INPUT,$POSITIVE_OUTPUT,$NEGATIVE_OUTPUT]`
