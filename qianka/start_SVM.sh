...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/qianka_SVM.py --dest /home/hadoop/qianka_SVM.py
...
TRAIN_DATA_PATH=s3://datamining.ym/user_profile/commerce/lrdata/positive_train/*
SVM_MODEL_PATH=s3://datamining.ym/user_profile/commerce/lrdata/SVM_MODEL

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=interest,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"Count interest $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,10,/home/hadoop/qianka_SVM.py,$TRAIN_DATA_PATH,$SVM_MODEL_PATH]`
