...
CLUSTER_NAME="awscn-up-emr-qianka"
...
aws emr put --cluster-id $cluster_id --key-pair-file ./key/id_rsa --src ./spark/match_idfa_install.py --dest /home/hadoop/match_idfa_install.py
...
IDFA_PATH=s3://datamining.ym/user_profile/commerce/dict/idfa1104.csv
OUTPUT_PATH=s3://datamining.ym/user_profile/commerce/qianka/${DATE}

step_result=`aws emr add-steps --cluster-id $cluster_id --steps Type=CUSTOM_JAR,Name=interest,Jar=s3://cn-north-1.elasticmapreduce/libs/script-runner/script-runner.jar,ActionOnFailure=TERMINATE_CLUSTER,Args=[/home/hadoop/spark/bin/spark-submit,--name,"Count interest $DATE",--master,$SPARK_MASTER,--executor-memory,3G,--total-executor-cores,10,/home/hadoop/match_idfa_install.py,$USER_INSTALL_PATH,$IDFA_PATH,$OUTPUT_PATH]`
